    ...
    <nav className="fixed top-0 w-full bg-white/95 backdrop-blur-md border-b border-slate-200 z-50">
      <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-4 group">
          <img src={logo} alt="MoSPI Logo" className="w-20 h-20 transition-transform group-hover:scale-105 drop-shadow-md" />
          <div className="leading-tight">
            <span className="font-bold text-navy-800 text-lg tracking-wide block">MPLADS DRISHTI</span>
            <span className="text-xs text-slate-500 tracking-widest uppercase">MoSPI • Government of India</span>
          </div>
        </Link>
